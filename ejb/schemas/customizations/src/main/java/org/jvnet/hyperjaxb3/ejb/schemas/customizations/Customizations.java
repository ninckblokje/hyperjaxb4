...
public class Customizations {
	...
	static {
		...
		namespaces.add("http://xmlns.jcp.org/xml/ns/persistence");
	...
	public static final String CONTEXT_PATH = ContextUtils.getContextPath(
			org.jcp.xmlns.xml.ns.persistence.ObjectFactory.class,
			org.jcp.xmlns.xml.ns.persistence.orm.ObjectFactory.class,
	...
	private final static org.jcp.xmlns.xml.ns.persistence.ObjectFactory persistenceObjectFactory = new org.jcp.xmlns.xml.ns.persistence.ObjectFactory();

	private final static org.jcp.xmlns.xml.ns.persistence.orm.ObjectFactory ormObjectFactory = new org.jcp.xmlns.xml.ns.persistence.orm.ObjectFactory();
	...
	public static org.jcp.xmlns.xml.ns.persistence.ObjectFactory getPersistenceObjectFactory() {
		return persistenceObjectFactory;
	}

	public static org.jcp.xmlns.xml.ns.persistence.orm.ObjectFactory getOrmObjectFactory() {
