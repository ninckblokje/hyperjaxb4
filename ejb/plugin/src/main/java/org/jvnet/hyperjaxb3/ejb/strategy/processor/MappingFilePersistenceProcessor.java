...
public class MappingFilePersistenceProcessor implements
	...
	public Collection<ClassOutline> process(EjbPlugin plugin, Outline outline,
		...
		final Persistence.PersistenceUnit persistenceUnit = getPersistenceUnitFactory()
	...
	protected Persistence createPersistence(EjbPlugin plugin,
											final Persistence.PersistenceUnit persistenceUnit, String persistenceUnitName)
			throws JAXBException {

		final Persistence persistence;
		final Persistence.PersistenceUnit targetPersistenceUnit;
		...
		if (persistenceXml != null) {
			try {
				...
				for (final Persistence.PersistenceUnit unit : persistence
						.getPersistenceUnit()) {
